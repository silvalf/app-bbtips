# Script de inicialização automática para BBTips App
...
Write-Host "🚀 Iniciando BBTips App..." -ForegroundColor Green
...
Write-Host 'Backend iniciando em http://127.0.0.1:8000' -ForegroundColor Green
...
Write-Host ""
Write-Host "💡 Dica: Verifique o status dos servidores na página Home" -ForegroundColor Magenta
